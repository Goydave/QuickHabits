...
import { Loader2, Send, Sparkles, User, Bot, Trash, ArrowLeft } from 'lucide-react';
                ...
                <div className='flex items-center'>
                 ...
                 <AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
                    <AlertDialogTrigger asChild>
                        <Button variant="outline" size="sm" disabled={messages.length <= 1}>
                ...
                <ScrollArea className="flex-grow p-6" viewportRef={scrollAreaRef}>
                    ...
                    <AnimatePresence>
                        ...
                        >
                            ...
                            <div
                            className={cn(
                                'rounded-lg px-4 py-2 max-w-[80%] whitespace-pre-wrap shadow-sm',
                                message.role === 'user'
